...
// Modifed by Micahel Steer, May 2008
//
...
// Chebyshevbpf:1 n1 n2 n3 n=? f0=? bw=? z0=? ripple=? q=? 
// where:
...
// This file sets up the class for the Chebyshevbpf element

// The following is done in case Chebyshevbpf.h is included twice. If
#ifndef ChebyshevBPF_h
#define ChebyshevBPF_h 1

class ChebyshevBPF : public Element
{
	public:
// This is the prototype of the creator routine
  ChebyshevBPF(const string& iname);
